...
func (suite *PackagesSuite) TestListPackagesMavenSuccess() {
	...
	suite.reg.RepositoryConfig.On("Fetch", test.MockCtx(), test_handler.MockOrgId, repoUUID).Return(repo, nil)
	suite.reg.Domain.On("FetchOrCreateDomain", test.MockCtx(), test_handler.MockOrgId).Return(domainName, nil)
...
func (suite *PackagesSuite) TestListPackagesRepositoryNotFound() {
	...
	suite.reg.RepositoryConfig.On("Fetch", test.MockCtx(), test_handler.MockOrgId, repoUUID).Return(api.RepositoryResponse{}, &daoError)
